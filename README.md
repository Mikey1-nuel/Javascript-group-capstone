...
- **A list of different categories of meals**
...
- [Live Demo Link](https://mikey1-nuel.github.io/Javascript-group-capstone/)
...
- With a git cmd, git bash or visual studio terminal, clone repo with **``git clone https://github.com/Mikey1-nuel/Javascript-group-capstone.git``** to download the repository locally on your machine.
- Then you navigate to the folder in your code editor with the command **``cd Javascript-group-capstone``**.
